...
const LoginButton = () => {
  ...
  return (
    <>
      <a
        href={googleAuthUrl}
        className="inline-flex items-center pl-5 pr-8 py-3 text-base font-medium text-center text-white bg-indigo-500 rounded-lg
        hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-violet-300 dark:bg-violet-600 dark:hover:bg-violet-700
